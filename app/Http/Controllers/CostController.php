    ...
    public function index(Request $request){
      ...
      if(
       ...
       $request->session()->exists('status_c')      
        ...
        $costs = $this->search($condition[0],$condition[1],$condition[2],$condition[3],
...
if($this->checkCodeUpdate($request)){
 ...
 return view('cost.edit',['cost' => $cost,'errors' => $errors]);
            ...
            //UPADTEのログ
//            Crofun::log_update($cost,config('constant.COST'),config('constant.COST_EDIT'),$cost->company_id,$cost->cost_name,$cost->cost_code);
