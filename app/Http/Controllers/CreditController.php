...
class CreditController extends Controller
{
    ...
    public function log(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            $credit          = $this->search($company_id, $client_code, $client_name, $client_name_kana, $corporation_num, $get_data_st, $get_data_en);
        ...
        if (
            ...
            $credit = $this->search($condition[0], $condition[1], $condition[2], $condition[3], $condition[4], $condition[5], $condition[6]);
    ...
    public function search($company_id, $client_code, $client_name, $client_name_kana, $corporation_num, $get_data_st, $get_data_en)
    {
        ...
        if ($client_code != "") {
            ...
            $credit = $credit->where('customer_mst.client_code_main', $client_code);
        }
    ...
    public function validateData(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'get_data_st.date'       => trans('validation.get_data_st'),
            'get_data_en.date'       => trans('validation.get_data_en'),
