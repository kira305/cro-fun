...
class DepartmentController extends Controller
{
    ...
    public function edit(Request $request){
        ...
        if ($request->isMethod('post')) {
                ...
                //Crofun::log_update($department,config('constant.DEPARTMENT'),config('constant.DEPARTMENT_EDIT'),$department->headquarter()->company_id,$department->department_name,$department->department_list_code);
    ...
    public function validateData(Request $request){
          ...
          $validator = Validator::make($request->all(),[
                    ...
                    // 'department_list_code'       => 'required|max:4|regex:/^[a-zA-Z0-9あ-ん]*$/u',
