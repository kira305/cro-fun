...
class ImportSearchController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->isMethod('post')) {
             ...
             if ($validator->fails()) {
                ...
                return view('import_log.index',['errors' => $errors,'logs' => $logs]);
    ...
    */ 
    ...
    public function search($company_id,$import_type,$user_name,$status,$start_time,$end_time){
      ...
      $start_time   = ($start_time == '' || $start_time == null ) ? Common::get_min_created_time_import_log() : $start_time;
      $end_time     = ($end_time   == '' || $end_time == null) ? Common::get_max_created_time_import_log() : $end_time;
