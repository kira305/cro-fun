...
class TreeDiagramController extends Controller
{
    ...
    {  
        // dd($this->diagram_service->changeFormatToday());
        // Crofun::checkProject();
        //Crofun::checkCost();
        ...
        if($request->isMethod('post')){
            ...
            if ($validator->fails()) {
                ...
                $diagrams   = $this->diagram_service->diagramToday(Auth::user()->company_id);
                ...
                session(['pj_code'                          => $request->pj_code]);
                 ...
                 return view('diagram.index', ["diagrams"=>$diagrams,"errors" => $errors]);
            ...
            //         $deparment_code   = $department->department_list_code;
            //     }
            ...
            //      $group            = Group_MST::where('id',$request->group_id)->first();
            ...
            // }
             ...
             try {
                ...
                $diagrams = $this->diagram_service->getDiagramByCondition(
                                                                            $date,
                                                                            $company_id,
                                                                            $headquarter_code,
                                                                            $deparment_code,
                ...
                // $a = $this->diagram_service->getDataByDateAndCompanyID($date,$company_id);
            ...
            return view('diagram.index', ["diagrams"=>$diagrams,'company_id' => $company_id]);
