    ...
    public function create(Request $request){
         ...
         if ($request->isMethod('post')) {
                ...
                if($this->checkCodeRule($request)){
                          ...
                          $errors = $validator->errors();
                          return view('mail_mst.createm',['mail_mst' => $mail_mst,'status' => $mail_mst->status,'errors' => $errors]);
                          
                }

                if($this->checkCodeRule($request)){
                  return view('mail_mst.createm',['mail_mst' => $mail_mst,'unique' => trans('validation.code_unique')]);
                }
                if($mail_mst->save()){
