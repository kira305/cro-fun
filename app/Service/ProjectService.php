...
{   
    ...
    * return project's detail list
    */
    public function search($company_id,$headquarter_id,$department_id,$group_id,$client_code,$personal_code,$client_name,$project_code,$project_name,$project_status){
    ...
    */
    public function getProjectData($request){
        ...
        if($this->checkSessionExist($request) == 1){
            ...
            $projects  = $this->search($condition[0],$condition[1],$condition[2],$condition[3],$condition[4],$condition[5],$condition[6],$condition[7],$condition[8],$condition[9]);
    ...
    */
    ...
    public function getDataForCreateCsv($projects){
                ...
                $columns = array('プロジェクトコード', 'プロジェクト名', '担当事業本部', '担当部署', '担当Grp', '顧客コード', '顧客名','顧客名カナ','スーテタース');
