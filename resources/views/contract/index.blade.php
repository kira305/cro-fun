                                        ...
                                        <div class="row search-row">
                                            ...
                                            <div class="col-md-12 col-lg-6 search-form" >
                                                ...
                                                <div class="col-lg-9 col-sm-9 search-item">
                                                    ...
                                                    value="{{session('client_name_kana_cont')}}" name="client_name_kana"
                                                    type="text" size="80%" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-10 col-lg-offset-1 col-md-12">
                                        <div class="row search-row">
                                            ...
                                            <div class="col-md-12 col-lg-6 search-form" >
                                                ...
                                                <div class="text-danger">{{ $errors->has('created_at_st') ? $errors->first('created_at_st') : ''}}</div>
                                                <div class="text-danger">{{ $errors->has('created_at_en') ? $errors->first('created_at_en') : ''}}</div>
                                            </div>
                                        </div>
                                    </div>
                                    {{-- end --}}
                                ...
                                <table id="contract_table" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>@if($contract->project) {{  $contract->project->project_code }} @endif
                                            </td>
                                            <td>@if($contract->project) {{  $contract->project->project_name }} @endif
                                            </td>
                                            <td>{{ $contract->save_ol_name }}</td>
                                            <td>@if($contract->headquarter) {{  $contract->headquarter->headquarters }}
                                                @endif</td>
                                            <td>@if($contract->department) {{  $contract->department->department_name }}
                                                @endif</td>
