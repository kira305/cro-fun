                                    ...
                                    <div class="col-lg-10 col-lg-offset-1 col-md-12">
                                        <div class="row search-row">
                                            <div class="col-md-12 col-lg-6 search-form">
                                                <div class="search-title col-lg-4 col-sm-3">
                                                    <span class="">所属会社</span>
                                                </div>
                                                <div class="col-lg-8 col-sm-9 search-item">
                                    ...
                                    <div class="col-lg-10 col-lg-offset-1 col-md-12">
                                        <div class="row search-row">
                                            ...
                                            <div class="col-md-12 col-lg-6 search-form">
                                                ...
                                                <div class="col-lg-8 col-sm-9 search-item form-group">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <a
                                                    href="{{route('edit_cost', ['id' => $cost->id,'page'=>request()->page])}}">
