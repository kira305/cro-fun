                                    ...
                                    <div class="col-lg-10 col-lg-offset-1 col-md-12">
                                        <div class="row search-row">
                                            ...
                                            <div class="col-md-12 col-lg-6 search-form" >
                                                ...
                                                <div class="col-lg-9 col-sm-9 search-item">
                                                    <input type="text" value="{{session('client_code_cr_log')}}"
                                    ...
                                    <div class="col-lg-10 col-lg-offset-1 col-md-12">
                                        <div class="row search-row">
                                            <div class="col-md-12 col-lg-6 search-form" >
                                                ...
                                                <div class="col-lg-9 col-sm-9 search-item">
                                                    <input type="text" value="{{session('corporation_num_cr_log')}}"
                                            ...
                                            <div class="col-md-12 col-lg-6 search-form" >
                                                ...
                                                <div class="col-lg-9 col-sm-9 search-item">
                                                    ...
                                                    value="{{session('client_name_kana_cr_log')}}"
                                        ...
                                        <div class="row search-row">
                                            <div class="col-md-12 col-lg-6 search-form" >
                                                ...
                                                <div class="col-lg-4 col-sm-4 search-item">
                                                    <input type="text" value="{{session('get_data_st_cr_log')}}"
                                                ...
                                                <div class="col-lg-4 col-sm-4 search-item">
                                                    <input type="text" value="{{session('get_data_en_cr_log')}}"
                                                    name="get_data_en" id="datepicker2" class="form-control">
                                                </div>
                                                <div class="text-danger">{{ $errors->has('get_data_st') ? $errors->first('get_data_st') : ''}}</div>
                                                <div class="text-danger">{{ $errors->has('get_data_en') ? $errors->first('get_data_en') : ''}}</div>
                                            </div>
                                            ...
                                            <div class="col-md-12 col-lg-6 search-form" >
                                                ...
                                                <div class="col-lg-4 col-sm-4 search-item">
                                                    <input type="text" value="{{session('expiration_data_st_cr_log')}}"
                                                ...
                                                <div class="col-lg-4 col-sm-4 search-item">
                                                    <input type="text" value="{{session('expiration_data_en_cr_log')}}"
                                                    name="expiration_data_en" id="datepicker4" class="form-control">
                                                </div>
                                                <div class="text-danger">{{ $errors->has('expiration_data_st') ? $errors->first('expiration_data_st') : ''}}</div>
                                                <div class="text-danger">{{ $errors->has('expiration_data_en') ? $errors->first('expiration_data_en') : ''}}</div>
                                            </div>
                                        </div>
                                    </div>
                                    {{-- end --}}
                                ...
                                <table id="credit_log_table" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{  date('Y年m月d日',strtotime($credit->get_time)) }}</td>
                                            <td>{{  $credit->rank }}</td>
                                            ...
                                            <td>
                                                ...
                                                {{  date('Y年m月d日',strtotime($credit->expiration_date)) }}
                                                @endif
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                @if( Auth::user()->can('credit-edit'))
                                                @if(strpos(Crofun::Url_explain(), 'customer/edit') !== false &&
                                                request()->client_id != null)
                                                <a href="{{route('edit_credit', ['id' => $credit->id,'url_id' => 1])}}">
                                                    <button style="float: left;" class="btn btn-info btn-sm">参照
                                                    </button>
                                                </a>
                                                @elseif(strpos(Crofun::Url_explain(), 'customer/view') !== false &&
                                                request()->client_id != null)
                                                <a href="{{route('edit_credit', ['id' => $credit->id,'url_id' => 2])}}">
                                                    <button style="float: left;" class="btn btn-info btn-sm">参照
                                                    </button>
                                                </a>
                                                @else
                                                <a
                                                    href="{{route('edit_credit', ['id' => $credit->id,'page'=>request()->page])}}">
                                                    <button style="float: left;" class="btn btn-info btn-sm">参照
                                                    </button>
                                                </a>
                                                @endif
...
<script type="text/javascript">
    $(document).on('click', '#clear', function () {
		//1ページに移動
         ...
         $('#datepicker').val('');
         $('#datepicker2').val('');
         $('#expiration_data_st').val('');
         $('#expiration_data_en').val('');
         $( "#form" ).submit();
