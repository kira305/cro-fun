                                    ...
                                    <div class="col-lg-10 col-lg-offset-1 col-md-12">
                                        <div class="row search-row">
                                            ...
                                            <div class="col-md-12 col-lg-6 search-form" >
                                                ...
                                                <div class="col-lg-9 col-sm-9 search-item">
                                                    <input type="text" id="client_code" value="{{ session('client_code_crdit') }}" class="form-control" autocomplete="off" name="client_code">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row search-row">
                                            <div class="col-md-12 col-lg-6 search-form" >
                                                ...
                                                <div class="col-lg-9 col-sm-9 search-item">
                                                    ...
                                                    value="{{ session('corporation_num_crdit') }}" class="form-control"
                                            ...
                                            <div class="col-md-12 col-lg-6 search-form" >
                                                ...
                                                <div class="col-lg-9 col-sm-9 search-item">
                                                    ...
                                                    value="{{ session('client_name_crdit') }}" class="form-control"
                                        ...
                                        <div class="row search-row">
                                            <div class="col-md-12 col-lg-6 search-form" >
                                                ...
                                                <div class="col-lg-4 col-sm-4 search-item">
                                                    <input id="start_time" value="{{ session('start_time_crdit') }}"
                                                ...
                                                <div class="col-lg-4 col-sm-4 search-item">
                                                    <input type="text" id="end_time" value="{{ session('end_time_crdit') }}"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($customer->ex_date != null)
                                                        {{date('Y年m月d日',strtotime($customer->ex_date)) }}
                                                    @endif
                                                </td>
                                                {{-- 取得日	 --}}
                                                <td>
                                                    @if($customer->get_time)
                                                        {{date('Y年m月d日',strtotime($customer->get_time)) }}
                                                    @endif
                                                </td>
                                                {{-- 格付け情報--}}
                                                <td>
                                            ...
                                            <td colspan="12">
                                                <table class="table table-config table-hover table-striped" rules="all">
                                                    ...
                                                    @if(
                                                    $customer->checkReceivableExist() != false
                                                    )
                                                    <tr>
                                                        @php
                                                        ...
                                                        <td class="infor1 text-center bg-info">
                                                            ...
                                                            {{date('Y年m月',strtotime($titleItem->target_data)) }}
