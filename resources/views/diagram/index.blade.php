  ...
  @include('layouts.confirm_js')
				            ...
				            <div class="box-body">
				            	<div class="row input_time">
						          ...
						          <div class="col-sm-2"> 
                                     ...
                                     autocomplete="off" style="float: : left;" type='text' name="search_date" id='datepicker'>

					              </div> 
                                  <div class="col-sm-1">
                                  	<button class="btn-sm" type="submit" style="float: : left;" >表示</button>
                                  </div>

					              <div class="col-sm-1">

					              	<p style="float:right;">出力期間  </p>

					              </div> 
                                  <div class="col-sm-2"> 

                                  	 <input class="form-control input-sm" autocomplete="off" id="start_date" type="" name="" value="">
                                  
					              </div>

					              <div class="col-sm-2">

					              	 <input class="form-control input-sm" autocomplete="off"  id="end_date" type="" name="" value="">
					              </div>
					              <div class="col-sm-1">
				             ...
				             <!--  <br><br>  --> 
					              ...
					              <table  class="table table-bordered table-hover">
					                ...
					                <tr>
					                  ...
					                  <th class="col-md-1">
                                           <select class="form-control" name="headquarter_id" id="headquarter_id_d">
							    ...
							    {{ session('headquarter_id_tr') == $headquarter->headquarters_code ? 'selected' : '' }}
							                    ...
							                    value="{{$headquarter->headquarters_code}}">{{$headquarter->headquarters_code}}:{{$headquarter->headquarters}}
							                    </option>
					                  ...
					                  <th class="col-md-1">
                                         <select class="search form-control" id="department_id_d" name="department_id">
					                          <option value="" data-id = "" > </option>
							       ...
							       {{ session('department_id_tr') == $department->department_code ? 'selected' : '' }}
							                    ...
							                    value="{{$department->department_code}}">{{$department->department_code}}:{{$department->department_name}}
							                    </option>
					                  ...
					                  <th class="col-md-1">
					                     <select class="search form-control"  name="group_id" id="group_id_d">
								          ...
								          @foreach($groups as $group)
						                    ...
						                    value="{{$group->group_code}}">{{$group->group_code}}:{{$group->group_name}}
						                    </option>
					            ...
					            {{ session('genka') == $genka->cost_code ? 'selected' : '' }}
					                  ...
					                  <th class="col-md-1">
					                  	<select class="search form-control" id="pj_gr_code" name="pj_gr_code">
                                            <option value="" selected></option>   
										    @foreach($projects as $project)
									            <option class="pj_gr_code" 
							    {{ session('pj_gr_code') == $project->project_grp_code ? 'selected' : '' }}
									                value="{{$project->project_grp_code}}">{{$project->project_grp_code}}:{{$project->project_grp_name}}
									            </option>
							    ...
							    value="{{$project->project_code}}">{{$project->project_code}}:{{$project->project_name}}
									            </option>
					                  ...
					                  <tbody>
	                                     ...
	                                     <tr>
							                ...
							                <td>{{$diagram->headquarters_code}}:{{$diagram->headquarters}}</td>
							                <td>
      ...
      <script type="text/javascript">
        ...
        $(document).on('change', '#company_id', function () {
        	 ...
        	 // $('#headquarter_code').val(headquarter_code);
       ...
       $(document).on('change', '#department_id_d', function () {
        	 ...
        	 // var department_code  = $('#department_id_d').find('option:selected').data('id');
        	 ...
        	 // $('#department_code_x').val(department_code);
       ...
       $(document).on('change', '#pj_gr_code', function () {
        	 ...
        	 // var pj_gr_code  = $('#pj_gr_code').val();
        	 // $('#pj_gr').val(pj_gr_code);
        	 $('#diagram').submit();
       ...
       $(document).on('change', '#pj_code', function () {
        ...
        function diagram(){
                 ...
                 if(start_date != "" && end_date == ""){
                   ...
                   // end_date  = $.datepicker.formatDate('yy-mm-dd', new Date());
    ...
    //                               remove_old_genka();
    //                               print_data_genka(data.list_genka);
    ...
    //                               remove_old_hanka();
    //                               print_data_hanka(data.list_hanka);
    ...
    //                               remove_old_project();
    //                               print_data_project(data.list_project);
        ...
        function print_data_genka(data){
          ...
          //新しい値をセット
            $.each(data, function(i, item) {
              ...
              $("#cost").append("<option data-id='"+data[i].company_id+"' class = 'genka' value='"+data[i].cost_code+"'>"+data[i].cost_code+"</option>");
        ...
        function print_data_hanka(data){
          ...
          //新しい値をセット
            $.each(data, function(i, item) {
              ...
              $("#selling").append("<option data-id='"+data[i].company_id+"' class = 'hanka' value='"+data[i].cost_code+"'>"+data[i].cost_code+"</option>");
        ...
        function print_data_project(data){
          ...
          //新しい値をセット
            $.each(data, function(i, item) {
              ...
              $("#pj_gr_code").append("<option data-id='"+data[i].company_id+"' class = 'pj_gr_code' value='"+data[i].get_code+"'>"+data[i].get_code+"</option>");

             });
            
            $.each(data, function(i, item) {

              $("#pj_code").append("<option data-id='"+data[i].company_id+"' class = 'pj_code' value='"+data[i].project_code+"'>"+data[i].project_code+"</option>");
