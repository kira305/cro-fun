						        ...
						        <form id="create_user" method="post" action="{{ url('global_info/edit') }}" enctype="multipart/form-data" name="MainForm">
				                       ...
				                       <input type="hidden" name="id" value="{{$global_info->id}}">
								        ...
								        <div class="row">
								                ...
								                <div class="col-md-3 offset-md-3">
									              <a href="{{route('global_info.download', ['id' => 0,'ol_name' =>$global_info->save_ol_name ,'sv_name' => $global_info->save_sv_name])}}" >{{$global_info->save_ol_name}}</a>
						                ...
						                <div class="row">
						                	<br>
								                <div class="col-md-5">
								                  ...
								                  <button type="submit" style="float:right;width: 200px;" class="btn btn-primary" name="mode1" value="add">登録</button>
								                </div>
                                                <div class="col-md-5">
