                                        ...
                                        <div class="col-lg-10 col-md-12 col-lg-offset-1">
                                            <div class="row search-form">
                                                <div class="col-lg-6 form-group">
                                                    <label>掲載開始</label>
                                                    <div class="id-change">
                                                        <input type="text" id="start_date" name="start_date" class="form-control m-r-15"
                                        ...
                                        <div class="col-lg-10 col-md-12 col-lg-offset-1">
                                            <div class="row search-form">
                                                <div class="col-lg-6 form-group">
                                                    <label>掲載終了</label>
                                                    <div class="id-change">
                                                        <input type="text" id="end_date" name="end_date" class="form-control m-r-15"
                                        ...
                                        <div class="col-lg-10 col-md-12 col-lg-offset-1">
                                            <div class="row search-form">
                                                <div class="col-lg-4 form-group">
                                                    <label class="checkbox-title">削除</label>
                                                    <div class="icheck-primary d-inline ">
                                                        <input type="checkbox"class="input_checkbox"  name="delete_flg" id="delete_flg" @if($global_info->delete_flg == 1) checked @endif value="1" >
