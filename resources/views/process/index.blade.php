                                            ...
                                            <div class="col-md-12 col-lg-6 search-form" >
                                                ...
                                                <div class="col-lg-9 col-sm-9 search-item">
                                                    <select class="form-control" id="company_id" name="company_id">
                                                        ...
                                                        <option @if(session()->has('company_id_pr'))
                                    ...
                                    <div class="col-lg-10 col-lg-offset-1 col-md-12">
                                        <div class="row search-row">
                                            <div class="col-md-12 col-lg-6 search-form" >
                                                ...
                                                <div class="col-lg-9 col-sm-9 search-item">
                                                    <input type="text" value="{{session('client_code_pr')}}"
                                            ...
                                            <div class="col-md-12 col-lg-6 search-form" >
                                                ...
                                                <div class="col-lg-9 col-sm-9 search-item">
                                                    <input id="client_name_kana" value="{{session('client_name_kana_pr')}}"
                                        ...
                                        <div class="row search-row">
                                            <div class="col-md-12 col-lg-6 search-form display-flex">
                                                ...
                                                <div class="search-item width-100 ">
                                                    <input type="text" value="{{session('project_code_pr')}}"
                                            ...
                                            <div class="col-md-12 col-lg-6 search-form display-flex" >
                                                ...
                                                <div class="search-item width-100">
                                                    <input type="text" value="{{session('project_name_pr')}}"
                                    ...
                                    <div class="col-lg-10 col-lg-offset-1 col-md-12">
                                        <div class="row search-row">
                                            <div class="col-md-12 col-lg-6 search-form" >
                                                ...
                                                <div class="col-lg-9 col-sm-9 search-item">
                                                    <input type="text" value="{{session('corporation_num_pr')}}"
                                            ...
                                            <div class="col-md-12 col-lg-6 search-form" >
                                                ...
                                                <div class="col-lg-4 col-sm-4 search-item">
                                                    <input type="text" value="{{session('target_data_st_pr')}}"
                                                ...
                                                <div class="col-lg-4 col-sm-4 search-item">
                                                    <input type="text" value="{{session('target_data_en_pr')}}"
                                ...
                                <table id="process_table" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{  date('Y年m月',strtotime($processes->target_data)) }}</td>
                                            <td style="text-align: right">
                                                {{  number_format(($processes->debit - $processes->credit) / 1000) }}
                                            </td>
                                            <td>
