                ...
                <div class="timeline-item">
                    <div class="timeline-body">
                        <div class="box-body p-20">
                            <p class="message">{{ isset($message) ? $message : Session::get('message') }}</p>
                            <p class="text-danger text-center">{{ $errors->has('message') ? $errors->first('message') : ''}}</p>
                            <form id="edit_project" method="post" action="{{ url('project/edit?id=' . $project->id) }}">
                                @csrf
                                {{-- row 1 --}}
                                <div class="row">
                                ...
                                <div class="row p-b-20">
                                    <div class="col-lg-12 ">
                                        ...
                                        <div class="col-lg-3 col-sm-3" >
                                            <a href="{{ url('project/index?page=' . request()->page) }}">
