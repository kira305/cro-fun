                                                        ...
                                                        <select class="form-control" id="company_id" name="company_id_p">
                                                            @foreach ($companies as $company)
                                                                <option @if (session()->has('company_id_p'))
                                                                    @if (session('company_id_p') == $company->id)
                                                                        selected @endif
                                                                @else
                                                ...
                                                <div class="col-md-12 col-lg-6 search-form">
                                                    ...
                                                    <div class="col-lg-9 col-sm-9 search-item">
                                                        <input type="text" id="client_code"
                                                            value="{{ session('client_code') }}" class="form-control"
                                                            name="client_code">
                                                    </div>
                                                </div>
                                                <div class="col-md-12 col-lg-6 search-form">
                                                    ...
                                                    <div class="col-lg-9 col-sm-9 search-item">
                                                        <input type="text" id="personal_code"
                                                            value="{{ session('personal_code') }}" class="form-control"
                                                            name="personal_code">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-12 col-lg-6 search-form">
                                                    ...
                                                    <div class="col-lg-9 col-sm-9 search-item">
                                                        <input type="text" id="client_name"
                                                            value="{{ session('client_name') }}" class="form-control"
                                                            name="client_name">
                                                    </div>
                                                </div>
                                                <div class="col-md-12 col-lg-6 search-form">
                                                ...
                                                <div class="col-md-12 col-lg-6 search-form display-flex">
                                                    ...
                                                    <div class="search-item width-100 ">
                                                        <input type="text" id="project_code"
                                                            value="{{ session('project_code') }}" class="form-control"
                                                            name="project_code">
                                                    </div>
                                                </div>
                                                <div class="col-md-12 col-lg-6 search-form display-flex">
                                                    ...
                                                    <div class="search-item width-100">
                                                        <input type="text" id="project_name"
                                                            value="{{ session('project_name') }}" class="form-control"
                                                            name="project_name">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        @if (Auth::user()->can('update', $project) && Auth::user()->can('checkProjectParent', $project) == 0)
                                                            <a
                                                                href="{{ route('edit_project', ['id' => $project->id, 'page' => request()->page]) }}">
                                                        ...
                                                        @else
                                                            @if (Auth::user()->can('view', $project))
                                                                <a
                                                                    href="{{ route('view_project', ['id' => $project->id, 'show' => 1, 'page' => request()->page]) }}">
                                                                    <button style="float: left;"
