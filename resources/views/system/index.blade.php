                            ...
                            <form id="systemf" action="{{action('SystemController@confirmation')}}" method="POST">
                                ...
                                <div class="top">
                                    ...
                                    <a href="javascript:form.submit()">
                                        <button type="submit" name="act_bnt" value="row_add" style="float: none;"
                                            class="btn btn-success">項目追加</button>
                                    </a>
                                    @endif
                                    @endif
                                    @if (isset($message))
                                    <p class="" style="text-align: center;color: {{$message['color']}}">
                                        {{ $message['msg'] }}</p>
                                    @endif
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div style="text-align:center;">
                                        @if ($disabled_ctl == "")
                                        <a href="javascript:form.submit()">
                                            <button type="submit" name="act_bnt" value="row_conf"
                                                class="btn btn-primary btn-lg">確認</button>
                                        </a>
                                        @elseif ($disabled_ctl == "conf")
                                        <a href="{{ url('system/update') }}">
                                            <button type="submit" name="act_bnt" value="row_upd"
                                                class="btn btn-primary btn-lg">更新</button>
                                        </a>
                                        <a>
                                            <button type="submit" name="act_bnt" value="row_back"
                                                class="btn btn-danger btn-lg">戻る</button>
                                        </a>
                                        @endif
                                    </div>
                                </div>
