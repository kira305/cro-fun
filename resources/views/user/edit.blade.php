                ...
                <div class="timeline-item">
                    <div class="timeline-body">
                        <div>
                                        ...
                                        <div class="col-lg-10 col-md-12 col-lg-offset-1">
                                            <div class="row search-form">
                                                <div class="col-lg-12 form-group btn-upload-style">
                                                    ...
                                                    @endif
                                                    <div class="col-xs-3">
                                                        <a style="float: left" class="btn btn-danger search-button" href="{{ url('user/index?page='.request()->page) }}">戻る</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-10 col-md-12 col-lg-offset-1 " style="padding:20px 50px;">
