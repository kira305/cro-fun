                                                ...
                                                <div class="col-lg-9 col-sm-9 search-item">
                                                    <select class="form-control" id="rule_id" name="rule_id">
                                                        ...
                                                        <option class="rule_id" data-value="{{ $rule->company_id }}"
                                                            @if(isset($rule_id)) @if ($rule_id==$rule->id) selected @endif
                                                            @endif
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="{{ $user->id }}">
                                            <td>
                                                @if( Auth::user()->can('create','App\User'))
                                                <a
                                                    href="{{route('edituserinfor', ['id' => $user->id,'page' => request()->page])}}"><button
                                                        style="float: left;" class="btn btn-info btn-sm">編集</button></a>
                                                @endif
                                            </td>
