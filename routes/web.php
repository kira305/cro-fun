...
Route::middleware(['auth'])->group(function () {
    ...
    // 契約書情報検索
    Route::get('/contract/index', 'ContractController@index')->name('Contract_index')->middleware('can:view,App\Contract_MST');
    Route::post('/contract/index', 'ContractController@index');
    Route::get('/contract/view', 'ContractController@view')->name('contract_view');
